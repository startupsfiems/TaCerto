...
namespace TaCertoForms.Controllers {
    [SomenteLogado]
    public class RelatorioController : ControladoraBase {
        ...
        [Perfil(Perfil.Autor)]
        public ActionResult RelatorioProfessorIndex() {
            ViewBag.TotalAtividades = Collection.AtividadeList().Count();

            //Buscando número total de acessos
            ...
            ViewBag.TotalAcessos = db.LogLogin.Where(ll => alunosIds.Contains(ll.IdPessoa)).Count();
            
            return View();
        }

        public ActionResult RelatorioProfessorAcesso() {
            return View();
        }

		/*public ActionResult a(string dataInicio, string dataFim) {
