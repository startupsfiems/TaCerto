...
function midiaCreateSingleImage(el, data, width = "100%") {            
    el.html(
        ...
        '<a data-toggle="tooltip" data-placement="bottom" data-original-title="Remover imagem cadastrada" href="javascript:void(0)" id="' + data.IdMidia +'" class="btn btn-danger btn-xs btn-single-remove"><i class="fa fa-remove"></i></a>'+
    '');
}
