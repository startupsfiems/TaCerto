...
namespace TaCertoForms.Factory {
    public class DisciplinaTurmaMatrizCreator : BaseCreator, IFactoryDisciplinaTurma {
        ...
        public bool DeleteDisciplinaTurma(int? id) {
            ...
            //**1. Validação se disciplina turma possui uma atividade cadastrada
            TurmaDisciplinaAutor tda = db.TurmaDisciplinaAutor.Where(x => x.IdDisciplinaTurma == disciplinaTurma.IdDisciplinaTurma).FirstOrDefault();
            if(tda != null) {
